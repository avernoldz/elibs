		...
		<div class="main-container">
			...
			<div class="content-wrapper-scroll">
				...
				<div class="content-wrapper">
					...
					$adminAvatar = !empty($adminData['avatar']) ? $adminData['avatar'] : 'assets/images/default-avatar.png';
					?>
											...
											<div class="row">
												<div class="col-sm-6 col-12">
													<div class="d-flex flex-column align-items-center">
														<img src="uploads/<?php echo htmlspecialchars($adminAvatar); ?>" class="img-fluid change-img-avatar rounded-circle" width="150" height="150" alt="Admin Avatar">
