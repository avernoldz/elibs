    ...
    <div class="modal fade" id="modalError" tabindex="-1" aria-labelledby="modalErrorLabel" aria-hidden="true">
								...
								<li class="sidebar-dropdown active">
									...
									<div class="sidebar-submenu">
										<ul>
											...
											<li>
												<a href="admin_addstudent.php" class="current-page">Add Student</a>
											</li>
								...
								<li class="sidebar-dropdown ">
									...
									<div class="sidebar-submenu ">
										<ul>
											...
											<li>
												<a href="admin_requests.php">Student Book Requests</a>
											</li>
											<li>
		...
		<script src="assets/vendor/daterange/custom-daterange.js"></script>
			...
			<script src="assets/js/main.js"></script>
						...
						<!--	// Example of showing a modal based on a condition in PHP // -->
				<?php // If student is added successfully
				echo "<script>showSuccessAlert();</script>";

				// If LRN already exists
				echo "<script>showDuplicateAlert();</script>";

				// If there’s a general error
				echo "<script>showGeneralErrorAlert();</script>";

				// If there’s a file upload error
				echo "<script>showFileErrorAlert();</script>";
				?>
