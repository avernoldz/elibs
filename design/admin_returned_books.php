...
<head>
	...
	<!-- Title -->
	<title>PSHS eLib Admin Returned Books</title>
					...
					<li class="sidebar-dropdown active">
						...
						<div class="sidebar-submenu">
							<ul>
								...
								<li>
									<a href="admin_returned_books.php" class="current-page">Returned Books</a>
								</li>
								<li>
	...
	<div class="main-container">
		...
		<div class="page-header">
			...
			<ol class="breadcrumb d-md-flex d-none">
				...
				<li class="breadcrumb-item breadcrumb-active" aria-current="page">Book Returned List</li>
			</ol>
			<!-- Breadcrumb end -->
			...
			<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-sm-12 col-12">
						...
						<!-- Card start -->
						<?php include 'book_table_return.php' ?>
						<!-- Card end -->
