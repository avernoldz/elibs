...
$sql = "SELECT * FROM archived_theses ORDER BY archived_at DESC";
							...
							<a  href="admin_index.php">
								...
								<li class="sidebar-dropdown ">
									...
									<div class="sidebar-submenu ">
										<ul>
											...
											<li>
												<a href="admin_archivesbooks.php">Archive Books</a>
											</li>
								...
								<div class="sidebar-submenu">
									<ul>
                                        ...
                                        <li>
                                            <a href="admin_archivedthesis.php" class="current-page">Archived Thesis</a>
                                        </li>
				...
				************* -->
				<div class="main-container">
					...
					<div class="content-wrapper-scroll">
                        ...
                        <?php include 'archive_thesis_table.php';?>
						<!-- Row end -->		
						</div>
						<!-- Content wrapper end -->
						<!-- App Footer start -->
...
Swal.fire({
    ...
    text: 'The thesis was successfully moved back to the catalog.',
});
</script>
<?php endif; ?>
