...
$sql = "SELECT br.request_id, br.request_date, br.status, br.expected_pickup_date, br.due_date, 
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <div class='media-box'>
                                        <div class='media-box-body'>
                                            <div class='text-truncate'>" . htmlspecialchars($row['book_title']) . "</div>
                                        </div>
                                    </div>
                                </td>";
                            echo "<td class='request-id'>" . htmlspecialchars($row['request_id']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['request_date']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['expected_pickup_date'] ? $row['expected_pickup_date'] : 'Not Set') . "</td>";
                            echo "<td>" . htmlspecialchars($row['due_date'] ? $row['due_date'] : 'Not Set') . "</td>";
                            ...
                            if ($row['status'] == 'Approved') {
                                ...
                                echo "<td>
                                        <div class='actions'>
                                            ...
                                            <a href='#' class='setPickupDate' data-id='" . $row['request_id'] . "' data-bs-toggle='modal' data-bs-target='#setPickupDateModal'>
                                                <i class='bi bi-calendar text-blue'></i> 
                                            </a>";
                                if (!empty($row['expected_pickup_date'])) {
                                    echo "<a href='#' class='setDueDate' data-id='" . $row['request_id'] . "' data-bs-toggle='modal' data-bs-target='#setDueDateModal'>
