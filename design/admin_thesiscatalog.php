						...
						<div class="sidebarMenuScroll">
							...
							<a  href="admin_index.php">
								...
								<li class="sidebar-dropdown ">
									...
									<div class="sidebar-submenu">
										<ul>
											...
											<li>
												<a href="admin_archivestudent.php">Faculty List</a>
											<li>
								...
								<li class="sidebar-dropdown ">
									...
									<div class="sidebar-submenu ">
										<ul>
											...
											<li>
												<a href="admin_archived_books.php">Archived Books</a>
											</li>
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="admin_thesiscatalog.php" class="current-page">Thesis Catalog</a>
										</li>
										<li>
				...
				<div class="main-container">
					...
					<div class="page-header">
						...
						<ol class="breadcrumb d-md-flex d-none">
							...
							<li class="breadcrumb-item breadcrumb-active" aria-current="page">Thesis Catalog</li>
						</ol>
						<!-- Breadcrumb end -->
...
<div class="modal modal-dark fade" id="viewRow" tabindex="-1" aria-labelledby="viewRowLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewRowLabel">Thesis Abstract</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="customer-card" id="thesisDetails">
                            <h6>Loading...</h6>
                        </div>
                    </div>
                </div>
			...
			************* -->
            ...
            <script>
// jQuery to handle the modal trigger
$(document).on('click', '.viewRow', function() {
    var thesisId = $(this).data('id'); // Get the thesis ID from the data attribute
    $.ajax({
        url: 'view_thesis.php', // The URL to the PHP file that fetches thesis details
        type: 'GET',
        data: { id: thesisId }, // Pass the thesis ID as a query parameter
        success: function(data) {
            $('#thesisDetails').html(data); // Fill the modal with the fetched data
        },
        error: function() {
            $('#thesisDetails').html('<p>Error fetching thesis details.</p>');
        }
    });
});
</script>
