                    ...
                    <form action="student_account_setting.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-12 text-center mb-3">
                                ...
                                <img src="<?php echo !empty($studentData['avatar']) ? htmlspecialchars($studentData['avatar']) : 'uploads/profile_images/default-avatar.jpg'; ?>" 
                                     alt="Profile Picture" width="100" height="100" class="rounded-circle mb-2">
