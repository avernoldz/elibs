                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    ...
                                                    <?php
                                                        // Add the Archive button inside the Actions column
                                                        if ($row['status'] == 0) { // Assuming status 0 means pending deletion
                                                    ?>
                                                    <a 
                                                        <button type="button" class="btn btn-link archiveRow" data-id="<?php echo $row['lrn']; ?>">
