					...
					<li class="sidebar-dropdown active">
						...
						<div class="sidebar-submenu">
							<ul>
								...
								<li>
									<a href="admin_requests.php" class="current-page">View Book Requests</a>
								</li>
								<li>
	...
	<div class="main-container">
		...
		<div class="page-header">
			...
			<ol class="breadcrumb d-md-flex d-none">
				...
				<li class="breadcrumb-item breadcrumb-active" aria-current="page">Book Request List</li>
			</ol>
			<!-- Breadcrumb end -->
			...
			<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-sm-12 col-12">
						...
						<!-- Card start -->
						<?php include 'book_table_request.php' ?>
						<!-- Card end -->
