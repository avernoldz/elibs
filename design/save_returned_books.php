...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $student_info = "
        SELECT books.isbn, students.phonenumber FROM book_requests 
    ...
    $body = "We would like to inform you that the book with ISBN: $student[isbn] has been successfully returned. \n\n Thank you for reading!";
