										...
										<form method="POST" enctype="multipart/form-data" action="add_thesis.php">
											<div class="row">
												...
												<div class="col-md-12 mb-3">
													<label for="abstractImage" class="form-label">Upload Abstract Image <span class="text-red">*</span></label>
				...
				<div class="modal fade" id="errorModal" tabindex="-1" aria-labelledby="errorModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								There was an error adding the thesis. Please try again.
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-dark" data-bs-dismiss="modal">Close</button>
							</div>
				...
				<div class="modal fade" id="fileErrorModal" tabindex="-1" aria-labelledby="fileErrorModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								There was an error uploading the abstract image. Please try again.
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-dark" data-bs-dismiss="modal">Close</button>
							</div>
        ...
        window.onload = function() {
            ...
            switch ('$status') {
                case 'success':
                    ...
                    break;
                case 'duplicate':
                    modal = new bootstrap.Modal(document.getElementById('duplicateModal'));
                    break;
                case 'file_error':
                    modal = new bootstrap.Modal(document.getElementById('fileErrorModal'));
                    break;
                case 'error':
