...
<head>
    ...
    <!-- Title -->
    <title>PSHS eLib Admin Book Report</title>
                    ...
                    <ul>
                        ...
                        <li class="sidebar-dropdown active ">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="admin_thesiscatalog.php">Student Report</a>
                                    </li>
                                    <li>
                                        <a href="admin_bookreport.php" class="current-page">Book Report</a>
                                    </li>
                                    <!-- <li>
        ...
        <div class="main-container">
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb d-md-flex d-none">
                    ...
                    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Reports</li>
                </ol>
                <!-- Breadcrumb end -->
